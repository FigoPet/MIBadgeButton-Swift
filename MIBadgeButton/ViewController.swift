...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        facebookButton.badgeEdgeInsets = UIEdgeInsets.init(top: 10, left: 0, bottom: 0, right: 15)
        twitterButton.badgeString = "180"
        twitterButton.badgeEdgeInsets = UIEdgeInsets.init(top: 10, left: 0, bottom: 0, right: 15)
        pinterestButton.badgeString = "22220"
        pinterestButton.badgeEdgeInsets = UIEdgeInsets.init(top: 10, left: 0, bottom: 0, right: 15)
    }
